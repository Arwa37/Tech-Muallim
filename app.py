...
st.markdown("""<style>
    ...
    /* اتجاه الصفحة وعموم الخطوط */
    html, body, [class*="css"] { font-family: 'Cairo', sans-serif; }
    .main { direction: rtl; text-align: right; }

    /* تثبيت السايد بار في اليسار وثبات لونه وثبات محتواه */
    [data-testid="stSidebar"] {
        background-color: #B71C1C !important;
        color: white !important;
        right: auto !important;
        left: 0 !important;
        direction: ltr !important; /* لتثبيت حركة القائمة وتجنب القفز */
    }
    [data-testid="stSidebar"] * {
...
st.markdown(
    '<div class="card"><h1>المكتبة الرقمية وأغلفة المناهج</h1><p>اختاري مقرر الفيزياء والفصل الدراسي لتفعيل السياق التعليمي.</p></div>',
    unsafe_allow_html=True)

col1, col2 = st.columns(2)
with col1:
    st.markdown('<div class="card"><h3>اختيار المقرر</h3>', unsafe_allow_html=True)
    courses = ["فيزياء 102 (فيز 102)", "فيزياء 210 (فيز 210)", "فيزياء 217 (فيز 217)", "فيزياء 218 (فيز 218)",
               "فيزياء 219 (فيز 219)"]
